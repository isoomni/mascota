...
public enum BaseResponseStatus {
    ...
    EMPTY_PET_NAME(false,2074,"반려동물 이름을 입력하세요"),
    EMPTY_PET_TYPE(false,2074,"반려동물 종을 입력하세요"),
    EMPTY_PET_FAMILY_DATE(false,2074,"반려동물이 가족이 된 날짜를 입력하세요"),
    OVER_SIX_CHAR(false,2073,"6자 이내로 작성해주세요"),
    EMPTY_PET_STATUS(false,2074,"반려동물 상태를 입력하세요"),
    FAIL_MODIFY_PET_INFO(false,2074,"반려동물 정보를 수정하는데 실패했습니다."),
    FAIL_DELETE_PET(false,2074,"반려동물 정보를 삭제하는데 실패했습니다."),
