<<<<<<< HEAD:src/main/java/com/example/demo/src/user/UserRepository.java
...
public interface UserRepository extends JpaRepository<User, Integer> {
    ...
    @Query("select u from user u where u.idx = :idx")
    Optional<User> findByIdx(Integer idx);
>>>>>>> fe947a315c6d9c4aeffaccd472c120edea4514ad:src/main/java/com/example/demo/src/repository/UserRepository.java
}